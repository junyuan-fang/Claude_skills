---
name: confluence
description: Use confluence-cli to read, search, create, update, move, like, and delete Confluence pages and attachments from the terminal (domain: cf.qunhequnhe.com, abbreviated as "cf"). 
---
...
```sh
export CONFLUENCE_TOKEN="your-scoped-token"
```
...
Like a Confluence page by ID or URL.
给 Confluence 页面 点赞。

```sh
confluence like <pageId>
```

```sh
confluence like 123456789
confluence like "https://company.atlassian.net/wiki/viewpage.action?pageId=123456789"
```
