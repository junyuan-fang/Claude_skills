...
- 2026-08-14 起进入"仅两档"稳定期:8/14、8/17、8/19、8/20、8/21、8/24 只跑 NVIDIA + 具身,论文推荐档已连续三周以上未触发
...
- NVIDIA 档耗时进入长尾常态(8/18 1533 秒、8/19 1288 秒、8/20 1245 秒、8/21 1896 秒、8/24 1370 秒),需预留至 07:45 之后;偶有短耗时(8/17 267 秒)
- 具身档耗时波动大(8/17 892 秒、8/19 219 秒、8/20 705 秒、8/21 756 秒、8/24 1279 秒),典型 700-1300 秒,可跑到 08:00 之后
...
- 新闻类任务只回"响应时间 X 秒"无摘要已成常态(2026-07-27 起持续至 8/24),需人工核对归档文件与实际推送是否真正执行
