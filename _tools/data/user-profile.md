...
- 一句话报告可在信号异常时补充结构性观察(如"WM 主题单日 6 篇"、"Alibaba AMAP 一日五发"、"2607.xxxxx 7 月洪峰启动"、"Physics-informed WM 成流派"、"CN 大厂 embodied 多元化")
- 询问功能现状时(如"你现在有 X 吗")期待明确 yes/no + 现状机制 + 开关配置路径 + 补跑选项,不要含糊
...
- concept MOC 自 2026-06-29 起从 288 篇扩张到 518 条(2026-07-06),paper MOC 从 26 → 58 条
- 日常触发时刻:NVIDIA 07:00、具身智能 07:05、论文推荐 07:15(每日固定节奏)
- 论文流水线耗时波动大:2026-06-29 耗时 1510s、06-30 耗时 1237s、07-01 真空期仅 329s、07-02 大丰收 1807s、07-03 洪峰 907s、07-06 耗时 1011s
- NVIDIA 任务耗时波动:2026-06-30 485s、07-01 433s、07-02 276s、07-03 370s、07-06 566s;常态约 4-10 分钟
...
- 未同步到 Zotero 的必读积压(截至 2026-07-06 约 15 篇):HallucinationWM / IDEA / HumanoidDART / PhysiFormer / AgileFlightGen / SynPriorS2R / QwenRobotManip / DVGWM / 3DPointWM / Valdi / PVWM / PhysMani / WorldSample / ACID
