...
- 一句话报告允许在必读数量异常(如仅 2 篇)时补充原因(如"余下多为前日重推")
...
- daily-papers 三步流水线(fetch → review → notes),日产推荐 18-20 篇、必读 2-3 篇并生成笔记
...
- 2026-06-29 论文流水线耗时 1510s(约 25 分钟),长于此前 ~17 分钟常态,可能与 concept MOC 扩容有关;2026-06-30 耗时 1237s(约 20 分钟)
- 2026-06-30 NVIDIA 任务耗时 485s(约 8 分钟),显著长于常态 ~4 分钟
...
- 2026-06-24 论文流水线收尾报告退化为"SkyJEPA done. Waiting on Foresight."(违反一句话报告规范,需避免在笔记仍在生成时提前回复);2026-06-25/26/29/30 已恢复标准一句话格式
- 当日推荐被前日重推稀释时(如 2026-06-30 必读仅 2 篇、余下多为 6/29 重推),需在一句话报告中点明原因
