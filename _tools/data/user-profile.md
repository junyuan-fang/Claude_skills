...
- daily-papers 三步流水线(fetch→review→notes):日更 Obsidian 论文笔记与目录页,概念/论文库持续增长(2026-07-31 为 813/81,2026-08-13 为 1098/101,2026-08-27 已达 1301/113)
- 论文笔记已支持双 vault 同步
- 推荐文件会做三档分流(必读/值得看/可跳过),并注明因超 14 天窗口或跑题被排除的论文(2026-08-27:20 篇入选 + 10 篇排除)
...
- 2026-08-14 至 08-25 为"仅两档"稳定期(NVIDIA + 具身);2026-08-26 起论文推荐档以一句话短 prompt 恢复并固定在 07:15,08-26/08-27 连续两天触发
- 2026-08-26、08-27 两天具身档均未触发,当前实际日程偏向"NVIDIA + 论文推荐"两档
...
- 论文推荐档稳定 2500-2750 秒(8/26 2530、8/27 2710),从 07:15 起跑到 08:00 才收尾,NVIDIA+论文两档已占满整个 07:00-08:00 窗口,是具身档近日缺席的可能原因
- 定时任务执行结果需事后核对:多次出现响应错位、空响应(2026-08-12 NVIDIA 档仅回零宽字符)、只回响应时间无内容摘要的情况
- 异常短耗时(2026-08-19 具身档 219 秒、2026-08-27 NVIDIA 档 394 秒)同样需核对归档是否真正生成
- 新闻类任务只回"响应时间 X 秒"无摘要已成常态(2026-07-27 起持续),需人工核对归档文件与实际推送是否真正执行
- 论文推荐档回报格式不稳定:2026-08-26 退化为单篇笔记校验确认(EchoWM 894 行),2026-08-27 则超出一句话要求给了多段汇报——目标是简洁三要素,额外洞察可加但不要淹没主信息
