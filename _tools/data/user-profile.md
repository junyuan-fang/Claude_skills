...
- 2026-08-14 起进入"仅两档"稳定期:8/14、8/17、8/19、8/20、8/21 只跑 NVIDIA + 具身,论文推荐档已连续两周以上未触发
...
- 三连任务窗口拥挤:NVIDIA 档单次 267-1896 秒、具身档 219-1195 秒、论文档 1400-2340 秒,叠加后极易在 08:30 额度重置前耗尽配额
- NVIDIA 档超时可挤占后续档:2026-08-18 NVIDIA 跑 1533 秒(至 07:49),当日具身档未触发
- NVIDIA 档耗时进入长尾常态(8/18 1533 秒、8/19 1288 秒、8/20 1245 秒、8/21 1896 秒),需预留至 07:45 之后;偶有短耗时(8/17 267 秒)
- 具身档耗时同样波动大(8/17 892 秒、8/19 219 秒、8/20 705 秒、8/21 756 秒),典型 700-900 秒
...
- 新闻类任务只回"响应时间 X 秒"无摘要已成常态(2026-07-27 起持续至 8/21),需人工核对归档文件与实际推送是否真正执行
